          ...
          {user ? (
            <>
              ...
              <button
                ...
                className="flex items-center gap-1.5 px-2.5 sm:px-3 py-1.5 rounded-xl border border-emerald-200/80 bg-emerald-50/70 hover:bg-emerald-100/70 text-xs font-semibold text-emerald-950 transition-all group"
                title="Click to edit your name"
              >
                <span className="w-5 h-5 rounded-full bg-emerald-700 text-white text-[10px] flex items-center justify-center font-bold uppercase shrink-0">
                  {user.name ? user.name.charAt(0) : "U"}
                </span>
                <span className="hidden sm:inline font-bold truncate max-w-[110px]">
                  {user.name}
                </span>
                <span className="text-[10px] bg-white text-emerald-800 font-bold px-1.5 py-0.5 rounded-md border border-emerald-200">
              ...
              <button
                ...
                className="hidden sm:flex items-center gap-1 px-2.5 py-1.5 rounded-xl border border-gray-200 bg-gray-50 hover:bg-gray-100 text-xs text-gray-700 transition-all"
              ...
              <button
                onClick={logout}
                className="flex items-center gap-1 p-2 text-gray-400 hover:text-red-600 hover:bg-red-50 rounded-xl transition-colors"
            ...
            <Link
              href="/login"
              className="flex items-center gap-1.5 px-4 py-2 rounded-xl bg-[#059669] hover:bg-[#047857] text-white text-xs font-bold transition-all shadow-sm"
            >
